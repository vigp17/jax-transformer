...
* **Vectorized Multi-Head Attention:** Implemented 8-head attention using JAX's functional paradigm for maximum parallelization.
...
By visualizing the 8 attention heads, we can observe the model's internal reasoning:
* **Local Focus:** Heads 6 and 7 concentrate on the diagonal, learning immediate syntactic relationships.
* **Global Context:** Heads 3 and 4 bridge long-range dependencies, identifying repeated tokens across the sequence.
...
2. Install dependencies: `pip install jax jaxlib matplotlib seaborn`
